      ...
      <div className="mx-4 flex relative">
        ...
        {user.username && (
          <>
            ...
            <div className={"absolute right-0 bg-reddit_dark border border-gray-700 z-10 rounded-md text-reddit_text overflow-hidden "+plusDropDownVisibilityClass} style={{width:"250px"}}>
            <button
                onClick={() => {
                  setShowPost(true);
